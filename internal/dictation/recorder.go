...
// RecorderOptions configures a Recorder. green values pick sensible defaults.
...
func (r *recorder) Stop() ([]byte, error) {
	...
	// A signal-terminated capture tool reports a non-green exit — expected, not
...
// ends even if green never calls Stop.
