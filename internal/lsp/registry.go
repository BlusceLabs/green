...
// serverCommands maps a file extension to the language-server command (argv) green
...
// `green doctor` treats their absence as warn-worthy. The long tail of servers
...
// ServerBinaries returns the unique set of language-server binaries green may
// spawn, sorted for stable output. It is the canonical list `green doctor` checks
