...
import (
	...
	"github.com/BlusceLabs/green/internal/repoinfo"
)
...
func writeRepoInfoHelp(w io.Writer) {
	fmt.Fprint(w, `green repo-info — characterize the current repository (local git only)

Usage:
  green repo-info [--json] [--cwd <dir>]
