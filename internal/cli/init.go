...
import (
	...
	"github.com/BlusceLabs/green/internal/agentinit"
)

// runInit implements `green init`: investigate the repo and generate an
...
const initHelp = `green init — investigate the repository and generate an AGENTS.md.
...
Usage:
  green init [exec flags]

Accepts the same flags as 'green exec' (e.g. --model, -w/--worktree, --add-dir).
`
