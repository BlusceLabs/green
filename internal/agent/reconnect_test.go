...
func (p *flakyProvider) StreamCompletion(_ context.Context, _ greenruntime.CompletionRequest) (<-chan greenruntime.StreamEvent, error) {
...
func TestStreamWithReconnectRecoversFromTransientDisconnect(t *testing.T) {
	...
	stream, err := streamWithReconnect(context.Background(), p, greenruntime.CompletionRequest{}, nil)
	if err != nil {
...
func TestStreamWithReconnectGivesUpAfterMax(t *testing.T) {
	...
	_, err := streamWithReconnect(context.Background(), p, greenruntime.CompletionRequest{}, nil)
	if err == nil {
...
func TestStreamWithReconnectStopsOnContextCancel(t *testing.T) {
	...
	_, err := streamWithReconnect(ctx, p, greenruntime.CompletionRequest{}, nil)
	if err == nil {
