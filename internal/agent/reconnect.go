...
func streamWithReconnect(ctx context.Context, provider Provider, request greenruntime.CompletionRequest, notify reconnectNotifier) (<-chan greenruntime.StreamEvent, error) {
