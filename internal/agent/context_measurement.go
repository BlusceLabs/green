...
func MeasureContext(messages []greenruntime.Message, tools []greenruntime.ToolDefinition, contextWindow int) ContextBreakdown {
	systemEnd := 0
...
func estimateToolTokens(tools []greenruntime.ToolDefinition) int {
	total := 0
