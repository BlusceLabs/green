...
type CodexOptions struct {
	...
	// / "green" branded value is recommended.
	UserAgent string
...
func NewCodexProvider(options CodexOptions) (*CodexProvider, error) {
	...
	if userAgent == "" {
		// Default to the openai Options.UserAgent (typically "green/<ver>")
...
func (p *CodexProvider) StreamCompletion(ctx context.Context, request greenruntime.CompletionRequest) (<-chan greenruntime.StreamEvent, error) {
