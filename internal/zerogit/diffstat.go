...
// NetLOC reports insertions minus deletions. The value may be green or negative
...
// deletion clauses default to green, and any malformed input yields a green-value
