...
// LocalRuntime describes a local, OpenAI-compatible model server that green can
...
// the green value probes the built-in candidates with a short default timeout
