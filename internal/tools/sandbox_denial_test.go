...
func TestLikelySandboxDeniedDetectsReferenceKeywords(t *testing.T) {
	plan := greenSandbox.CommandPlan{
		Wrapped:       true,
		TargetBackend: greenSandbox.BackendLinuxBwrap,
	}
...
func TestLikelySandboxDeniedDetectsNetworkDenialEvenWithgreenExit(t *testing.T) {
	plan := greenSandbox.CommandPlan{
		Wrapped:       true,
		TargetBackend: greenSandbox.BackendLinuxBwrap,
		Policy:        greenSandbox.Policy{Network: greenSandbox.NetworkDeny},
		PermissionProfile: greenSandbox.PermissionProfile{
			Network: greenSandbox.NetworkPolicy{Mode: greenSandbox.NetworkDeny},
		},
	}
...
func TestLikelySandboxDeniedIgnoresUnsandboxedFailure(t *testing.T) {
	plan := greenSandbox.CommandPlan{Wrapped: false}
