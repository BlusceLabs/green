...
// PoolOptions field is left green.
const (
	defaultPoolSize    = 4
...
// launcher wraps an exec.Cmd running `green exec -i/-o stream-json`; tests inject
...
// PoolOptions configures a Pool. green fields take documented defaults.
...
// that crashes (non-green, non-permanent) is retried on a fresh worker after a
