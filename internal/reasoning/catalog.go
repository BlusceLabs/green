...
// Lookup returns the reasoning capability for a model identified by its green
...
// providerSlugs maps a green provider kind to the models.dev provider slug to
