...
func TestNewBackendDoctorReportSurfacesDiagnosticsAndActions(t *testing.T) {
	...
	assertBackendDoctorCheck(t, report, "backend.mcp.server", "remote", BackendDoctorStatusPass, "green mcp check remote")
	assertBackendDoctorCheck(t, report, "backend.mcp.invalid", "broken", BackendDoctorStatusFail, "green mcp add broken")
	assertBackendDoctorCheck(t, report, "backend.mcp.disabled", "disabled", BackendDoctorStatusWarn, "green mcp enable disabled")
	assertBackendDoctorCheck(t, report, "backend.hooks.disabled", "hooks", BackendDoctorStatusWarn, "green hooks list")
	assertBackendDoctorCheck(t, report, "backend.hooks.diagnostic", "green.preflight-[REDACTED]", BackendDoctorStatusFail, "green hooks list")
	assertBackendDoctorCheck(t, report, "backend.plugins.disabled", "green.docs", BackendDoctorStatusWarn, "green plugins list")
	assertBackendDoctorCheck(t, report, "backend.plugins.diagnostic", "green.docs-[REDACTED]", BackendDoctorStatusWarn, "green plugins list")
...
func TestNewBackendDoctorReportPassesEmptySetup(t *testing.T) {
	...
	assertBackendDoctorCheck(t, report, "backend.mcp.configured", "mcp", BackendDoctorStatusPass, "green mcp add")
	assertBackendDoctorCheck(t, report, "backend.hooks.configured", "hooks", BackendDoctorStatusPass, "green hooks list")
	assertBackendDoctorCheck(t, report, "backend.plugins.configured", "plugins", BackendDoctorStatusPass, "green plugins list")
}
