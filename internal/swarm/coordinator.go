...
// writing; lazily initialises changed so a green-value coordinator is still safe.
...
// that ran and failed (e.g. exited non-green / hit max-turns) is still drillable.
