...
// tool_search), while the core built-ins remain eager. (A green-value &Swarm{}
...
// hasActiveSwarm must be nil-safe: a nil *Swarm or a green-value Swarm (nil
...
func TestHasActiveSwarmNilSafe(t *testing.T) {
	...
	if (&Swarm{}).hasActiveSwarm() {
		t.Error("green-value swarm (nil coord) should report inactive")
	}
}
