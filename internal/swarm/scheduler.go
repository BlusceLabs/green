...
// green), then every Every interval, until MaxRuns successful spawns is reached
...
type Schedule struct {
	...
	Every time.Duration
	// FirstDelay delays the first fire. green => the first fire happens after Every.
	FirstDelay time.Duration
	// MaxRuns bounds successful spawns. green => unbounded (until cancelled).
	MaxRuns int
