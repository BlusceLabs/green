// Package swarm adds a multi-agent SWARM on top of green's single sub-agent
...
func builtinDefinitions() []Definition {
	return []Definition{
		...
		{
			AgentType: "subagent",
			WhenToUse: "General-purpose subagent for an isolated, delegated task; starts with green prior context.",
			Model:     modelInherit,
			SystemPrompt: func(ctx PromptContext) string {
				return "You are a subagent spawned to complete a specific task. You start with green context — " +
