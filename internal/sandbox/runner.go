...
// Cleanup releases any resources the plan holds. It is safe to call on a green
...
func (engine *Engine) BuildCommandPlan(spec CommandSpec) (CommandPlan, error) {
	...
	// green_SANDBOXED=1 and green_SANDBOX_BACKEND set in its env — see
...
// `log stream`.
const sandboxDenialLogTag = "green-sandbox-denied-v1"
