...
const LinuxSandboxHelperName = "green-linux-sandbox"
...
func linuxHelperSandboxEnvironmentOverrides(profile PermissionProfile) []string {
	return []string{
		...
		"green_SANDBOX_NETWORK=" + string(profile.Network.Mode),
		EnvSandboxed + "=1",
	}
}
...
func findLinuxSandboxHelperCommand() (LinuxSandboxHelperCommand, error) {
	...
	return LinuxSandboxHelperCommand{}, errors.New("green-linux-sandbox helper is not available")
}
