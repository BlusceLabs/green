...
// infrastructure that `green sandbox setup` installs: the persistent outbound
	...
	return []WindowsWFPFilterSpec{
		{
			...
			Name:        "green_wfp_block_connect_v4",
		...
		},
		{
			...
			Name:        "green_wfp_block_connect_v6",
		...
		},
		{
			...
			Name:        "green_wfp_icmp_connect_v4",
		...
		},
		{
			...
			Name:        "green_wfp_icmp_connect_v6",
