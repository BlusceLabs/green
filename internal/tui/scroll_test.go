...
func TestAltScreenTranscriptScrollKeepsFooterFixed(t *testing.T) {
	...
	if !strings.Contains(bottom, "Ask green to fix, explain, or build") || !strings.Contains(bottom, "openai") {
	...
	if !strings.Contains(scrolled, "Ask green to fix, explain, or build") || !strings.Contains(scrolled, "openai") {
