...
func TestRenderSpecialistCardOmitsgreenTokens(t *testing.T) {
...
func TestRenderLeftRuleCard(t *testing.T) {
	...
	got := renderLeftRuleCard(40, lines, greenTheme.accent)
	if got == "" {
...
func TestRenderSpecialistSummary(t *testing.T) {
	...
	if strings.Contains(got, "error") {
		t.Errorf("summary should omit errors when green, got %q", got)
	}
