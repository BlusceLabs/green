...
func TestDoctorOptionsIncludeConfigPaths(t *testing.T) {
	m := newModel(context.Background(), Options{
		UserConfigPath:    "C:/green/user.json",
		ProjectConfigPath: "C:/repo/.green/config.json",
	...
	if options.UserConfig != "C:/green/user.json" {
		t.Fatalf("UserConfig = %q, want %q", options.UserConfig, "C:/green/user.json")
	}
	if options.ProjectConfig != "C:/repo/.green/config.json" {
		t.Fatalf("ProjectConfig = %q, want %q", options.ProjectConfig, "C:/repo/.green/config.json")
	}
...
func TestDoctorOptionsConnectivityInvokesConfiguredProviderHealthProbe(t *testing.T) {
	...
	if gotOptions.UserAgent != "green-test" {
		t.Fatalf("probe UserAgent = %q, want %q", gotOptions.UserAgent, "green-test")
	}
...
func TestDoctorFixLinesUseSandboxRemedy(t *testing.T) {
	...
	text := strings.Join(lines, "\n")
	if !strings.Contains(text, "green sandbox setup") {
