...
// desktop notifications) when green finishes a turn or needs user input.
package notify
...
// Config is the resolved notifier policy. green value (Mode=="") is silent.
type Config struct {
	Mode      Mode
	FocusMode FocusMode
}
