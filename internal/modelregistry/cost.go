...
func (registry Registry) EstimateCost(pattern string, usage greenruntime.Usage) (CostBreakdown, error) {
...
func CalculateCost(model ModelEntry, usage greenruntime.Usage) (CostBreakdown, error) {
