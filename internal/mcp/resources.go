...
import (
	...
	"github.com/BlusceLabs/green/internal/workspaceindex"
)
...
// the fields green populates are emitted; pagination cursors and icons are not
// used.
...
// binary extensions, ...) match the rest of green instead of re-walking.
