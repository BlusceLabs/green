...
func TestBuildChecksFromEnvDetectsBlockers(t *testing.T) {
	checks := BuildChecksFromEnv(map[string]string{
		"green_REVIEW_DIFF_CHECK": "success",
		"green_REVIEW_TEST":       "failure",
		"green_REVIEW_BUILD":      "success",
		"green_REVIEW_SMOKE":      "skipped",
	})
...
func TestBuildMarkdownApprovingReview(t *testing.T) {
	checks := BuildChecksFromEnv(map[string]string{
		"green_REVIEW_DIFF_CHECK": "success",
		"green_REVIEW_TEST":       "success",
		"green_REVIEW_BUILD":      "success",
		"green_REVIEW_SMOKE":      "success",
	})
	markdown := BuildMarkdown(SummaryInput{
		Number:       30,
		HeadSHA:      "abcdef1234567890",
		Checks:       checks,
		ChangedFiles: []string{"cmd/green-pr-review/main.go", "internal/review/review_test.go"},
	})
...
func TestBuildSummaryInputFromEnv(t *testing.T) {
	input := BuildSummaryInputFromEnv(map[string]string{
		"green_PR_NUMBER":         "42",
		"green_REVIEW_HEAD_SHA":   "0123456789abcdef",
		"green_REVIEW_DIFF_CHECK": "success",
		"green_CHANGED_FILES":     "b.go\na.go",
	})
