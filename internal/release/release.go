...
func Build(ctx context.Context, options BuildOptions) (BuildResult, error) {
	...
	if err := buildgreen(ctx, rootDir, output, version, goos, goarch); err != nil {
		return BuildResult{}, err
	}
	return BuildResult{
		OutputPath: output,
...
func Package(ctx context.Context, options PackageOptions) (PackageResult, error) {
	...
	if err := buildgreen(ctx, rootDir, artifactPath, version, goos, goarch); err != nil {
		return PackageResult{}, err
	}
...
func LinuxSandboxHelperArtifactName(goos string) string {
	if goos == "windows" {
		return "green-linux-sandbox.exe"
	}
	return "green-linux-sandbox"
}

func LinuxSeccompHelperArtifactName(goos string) string {
	if goos == "windows" {
		return "green-seccomp.exe"
	}
	return "green-seccomp"
}

func WindowsSandboxCommandRunnerArtifactName(goos string) string {
	if goos == "windows" {
		return "green-windows-command-runner.exe"
	}
	return "green-windows-command-runner"
}

func WindowsSandboxSetupArtifactName(goos string) string {
	if goos == "windows" {
		return "green-windows-sandbox-setup.exe"
	}
	return "green-windows-sandbox-setup"
}
...
func BuildLdflags(version string) string {
	return "-s -w -X github.com/BlusceLabs/green/internal/cli.version=" + version
}
...
func ReleasePackageName(version string, goos string, goarch string) (string, error) {
	...
	return fmt.Sprintf("green-v%s-%s-%s", version, platform, arch), nil
}
...
func buildgreen(ctx context.Context, rootDir string, output string, version string, goos string, goarch string) error {
	return buildGoPackage(ctx, rootDir, output, version, goos, goarch, "./cmd/green")
}
...
func buildLinuxSandboxHelper(ctx context.Context, rootDir string, output string, goos string, goarch string) error {
	...
	return buildGoPackage(ctx, rootDir, output, "", goos, goarch, "./cmd/green-linux-sandbox")
}
...
func buildLinuxSeccompHelper(ctx context.Context, rootDir string, output string, goos string, goarch string) error {
	...
	return buildGoPackage(ctx, rootDir, output, "", goos, goarch, "./cmd/green-seccomp")
}
...
func buildWindowsSandboxCommandRunner(ctx context.Context, rootDir string, output string, goos string, goarch string) error {
	...
	return buildGoPackage(ctx, rootDir, output, "", goos, goarch, "./cmd/green-windows-command-runner")
}
...
func buildWindowsSandboxSetup(ctx context.Context, rootDir string, output string, goos string, goarch string) error {
	...
	return buildGoPackage(ctx, rootDir, output, "", goos, goarch, "./cmd/green-windows-sandbox-setup")
}
...
func copyPackageFiles(rootDir string, stagingDir string, artifactPath string, stagedBinaryPath string, goos string, version string, helperArtifacts map[string]string) error {
	...
	if err := copyFile(filepath.Join(rootDir, "bin", "green.js"), filepath.Join(stagingDir, "bin", "green.js"), 0o755); err != nil {
		return err
	}
