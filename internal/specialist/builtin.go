...
const workerPrompt = `You are a focused task specialist inside green.
...
const explorerPrompt = `You are a read-only codebase exploration specialist inside green.
...
const codeReviewPrompt = `You are a code review specialist inside green.
